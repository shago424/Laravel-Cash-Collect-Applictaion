           ...
           <div class="card">
              <div class="card-header" style="background-color:   #f1c40f  ">
                <h5>Invoice No :<strong> {{$invoice->invoice_no}}</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invoice Date: <strong>{{date('d-m-Y',strtotime($invoice->invoice_date))}}</strong>
                  <a  style="font-weight: bold;font-size: 18px" href="{{route('invoices.pending-list')}}" class="btn btn-primary btn-sm float-right"><i class="fa fa-list"><strong style="font-size: 18px"> Invoice Pending List</strong></i></a>
                  <a  style="font-weight: bold;font-size: 18px" href="{{route('invoices.view')}}" class="btn btn-success btn-sm float-right"><i class="fa fa-list"><strong style="font-size: 18px"> Invoice Approved List</strong></i></a>
