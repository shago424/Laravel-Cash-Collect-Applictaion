...
<html lang="en">
  ...
  <body>
        ...
        <div style="font-size: 18px;margin-top: 7px;font-weight: bold;text-align: center;"><u ><i>Individual Member All Invoice Repoet</i></u></div>
           <br>
           ...
           <div class="card">
            ...
            <div class="card-body">
                ...
                <table width="100%" class="table table-bordered table-sm" border="1" >
                  <tbody>
                    <tr><th colspan="3" class="text-center" style="font-size: 20px">Member Information</th></tr>
                    <tr>
                      <th >Member Name</th>
                      <th >Mobile</th>
                      <th >Address</th>
                     ...
                     <tr>
                      <td >{{$alldata['0']['member']['member_name']}}</td>
                      <td  style="text-align: center;">{{$alldata['0']['member']['mobile']}}</td>
                      <td >{{$alldata['0']['member']['address']}}</td>
                    </tr>
                  </tbody>
                </table>
                <br>
